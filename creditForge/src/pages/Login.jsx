    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm">Corporate Credit Appraisal Platform</p>
        </div>
        ...
        <div className="bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="mt-6 pt-6 border-t border-slate-800">
            ...
            <div className="space-y-1 text-xs text-slate-600">
              <p>Admin: admin@creditforge.com / password123</p>
              <p>Analyst: analyst@creditforge.com / password123</p>
              <p>Viewer: viewer@creditforge.com / password123</p>
            </div>
          </div>
        </div>
